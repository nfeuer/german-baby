...
export default function PhraseCard({ phrase, topic, onToggleFavorite, isFavorite, onMarkLearned, isLearned }) {
    ...
    <div className="perspective-1000 h-64">
      ...
      >
        ...
        <div className="absolute w-full h-full card-back">
          <div
            className={`w-full h-full rounded-2xl shadow-lg p-6 flex flex-col justify-between ${topic.color} border-2 border-gray-200`}
          >
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-2">Click to flip back</p>
            </div>
          </div>
        </div>
      </div>
